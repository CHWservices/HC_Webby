...
export const comment = (() => {
    ...
    const comment = () => {
        ...
        const onNullComment = `<div class="h6 text-center fw-bold p-4 my-3 bg-theme-${theme.isDarkMode('dark', 'light')} rounded-4 shadow">Oops! Looks like nobody has commented yet... 😢 Be the first!</div>`;
